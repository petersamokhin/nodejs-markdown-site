(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    global.tagsInput = mod.exports.tagsInput
  }
})(this, function (exports, module) {
  'use strict'
  module.exports.tagsInput = tagsInput
  const BACKSPACE = 8,
    TAB = 9,
    ENTER = 13,
    LEFT = 37,
    ...
    COMMA = 44
  const SEPERATOR = ','
  let COPY_PROPS = 'placeholder pattern spellcheck autocomplete autocapitalize autofocus accessKey accept lang minLength maxLength required'.split(' ')
  ...
  function tagsInput (input) {
    ...
    base.input.addEventListener('keypress', function (e) {
      var el = base.input,
        key = e.keyCode || e.which,
        selectedTag = $('.tag.selected'),
        pos = el.selectionStart === el.selectionEnd && el.selectionStart,
    ...
    return savePartialInput
  }

  tagsInput.enhance = tagsInput.tagsInput = tagsInput
  tagsInput.savePartialInput = tagsInput.spi
})
